...
ARG PLUGIN_FINDBUGS_VERSION=4.0.3
...
ARG PLUGIN_DEPENCY_CHECK_VERSION=2.0.7
...
ARG PLUGIN_OPENID_VERSION=2.0.0
...
ARG PLUGIN_COMMUNITY_BANCH_VERSION=1.6.0
...
ARG PLUGIN_BUILD_BREAKER_VERSION=2.3.1
ARG PLUGIN_BUILD_BREAKER_BUILD_NO=347
ARG PLUGIN_BUILD_BREAKER_URL=https://github.com/adnovum/sonar-build-breaker/releases/download/${PLUGIN_BUILD_BREAKER_VERSION}/sonar-build-breaker-plugin-${PLUGIN_BUILD_BREAKER_VERSION}.${PLUGIN_BUILD_BREAKER_BUILD_NO}.jar

...
ARG PLUGIN_DEPENCY_CHECK_VERSION=3.1.0
...
ENV PLUGIN_COMMUNITY_BANCH_VERSION=1.8.3
...
USER sonarqube
ENTRYPOINT ["bin/copy_preinstall_plugins.sh", "bin/append_community_branch_plugin_javaagent_options.sh", "bin/run.sh"]
CMD ["bin/sonar.sh"]